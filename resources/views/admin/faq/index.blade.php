<x-app-layout>
    ...
    <div class="py-1">
        <div class="max-w-4xl mx-auto sm:px-2 lg:px-4">
            <div class="mb-4">
                <div class="mt-3">
                    <Link modal href="{{route('faq.create')}}"
            ...
            <div class="p-2 bg-white border-b border-gray-200 shadow-sm ">
                ...
                <x-splade-table :for="$FAQ">

                    <x-splade-cell edit class="w-4 hover:bg-indigo-700">
                        <Link modal href="{{ route('faq.edit', $item->id) }}"
                              class="text-indigo-500 font-bold hover:text-indigo-800">
                        Редактировать
                        </Link>
                    </x-splade-cell>
                    <x-splade-cell delete class="w-4 grid justify-items-center">
                        <div class="grid justify-items-center">
                            <Link
                                ...
                                href="{{ route('faq.destroy', $item->id) }}" method="DELETE"
