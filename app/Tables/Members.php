...
class Members extends AbstractTable
{
    ...
    public function for()
    {
        ...
        return MembersModel::query()->join('territorial_organizations', 'member.name_to', '=', 'territorial_organizations.id')->join('federal_district', 'member.region', '=', 'federal_district.id');
